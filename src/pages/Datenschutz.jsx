      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Allgemeine Hinweise</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Datenerfassung auf dieser Website</h3>
            
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
            <p className="mb-4">
              Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten
              können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle" in dieser Datenschutzerklärung entnehmen.
            </p>

            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Wie erfassen wir Ihre Daten?</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Wofür nutzen wir Ihre Daten?</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Analyse-Tools und Tools von Drittanbietern</h4>
            <p className="mb-4">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Strato</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Auftragsverarbeitung</h3>
            <p className="mb-4">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Datenschutz</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Hinweis zur verantwortlichen Stelle</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Speicherdauer</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Empfänger von personenbezogenen Daten</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Recht auf Datenübertragbarkeit</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Auskunft, Berichtigung und Löschung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Recht auf Einschränkung der Verarbeitung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">SSL- bzw. TLS-Verschlüsselung</h3>
            <p className="mb-4">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Cookies</h3>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Einwilligung mit Cookiebot</h3>
            <p className="mb-4">
              ...
              datenschutzkonform zu dokumentieren. Anbieter dieser Technologie ist Usercentrics A/S, Havnegade 39,
              1058 Kopenhagen, Dänemark (im Folgenden „Cookiebot").
            </p>
            <p className="mb-4">
              Wenn Sie unsere Website betreten, wird eine Verbindung zu den Servern von Cookiebot hergestellt, um
              Ihre Einwilligungen und sonstigen Erklärungen zur Cookie-Nutzung einzuholen. Anschließend speichert
              Cookiebot einen Cookie in Ihrem Browser, um Ihnen die erteilten Einwilligungen bzw. deren Widerruf
              zuordnen zu können. Die so erfassten Daten werden gespeichert, bis Sie uns zur Löschung auffordern, den
              Cookiebot-Cookie selbst löschen oder der Zweck für die Datenspeicherung entfällt. Zwingende gesetzliche
              Aufbewahrungspflichten bleiben unberührt.
            </p>
            <p className="mb-4">
              Der Einsatz von Cookiebot erfolgt, um die gesetzlich vorgeschriebenen Einwilligungen für den Einsatz von
              Cookies einzuholen. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. c DSGVO.
            </p>

            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Auftragsverarbeitung</h4>
            <p className="mb-4">
              Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung des oben genannten Dienstes
              geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der
              gewährleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren
          ...
          {/* Section 5: Analyse-Tools und Werbung */}
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Analyse-Tools und Werbung</h2>
            
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Google Analytics</h3>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">IP Anonymisierung</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Browser Plugin</h4>
            <p className="mb-4">
          ...
          {/* Section 6: Eigene Dienste */}
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Eigene Dienste</h2>
            
            <h3 className="text-lg font-semibold text-gray-900 mb-3 mt-6">Umgang mit Bewerberdaten</h3>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Umfang und Zweck der Datenerhebung</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Aufbewahrungsdauer der Daten</h4>
            <p className="mb-4">
            ...
            <h4 className="text-base font-semibold text-gray-900 mb-2 mt-4">Aufnahme in den Bewerber-Pool</h4>
            <p className="mb-4">
